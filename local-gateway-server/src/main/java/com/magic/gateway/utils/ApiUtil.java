package com.magic.gateway.utils;
...
public class ApiUtil {
    ...
    public static String aesEncrypt(String data) {
        return aesInst.encryptBase64(zipCompress(data));
    }

    public static String aesDecrypt(String data) {
        return aesInst.decryptStr(data);
    }

    private static byte[] zipCp(String data) {
        ZipInputStream zis = new ZipInputStream(new ByteArrayInputStream(data.getBytes()));
    ...
    private static byte[] zipUnCp(String data) {
        return null;
    }
